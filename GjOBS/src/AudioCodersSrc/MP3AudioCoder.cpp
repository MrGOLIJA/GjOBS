...
MP3AudioCoder::MP3AudioCoder(AVFormatContext* format, OutputDevice* device) : AudioCoder(format, device)
{
...
MP3AudioCoder::~MP3AudioCoder() {

}

void MP3AudioCoder::codeAudio(const char* data, int len) {
